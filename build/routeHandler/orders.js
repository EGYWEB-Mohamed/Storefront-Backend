...
var showOrder = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, order.show(parseInt(req.params.id))];
            case 1:
                results = _a.sent();
                if (results) {
                    res.json(results);
...
var createOrder = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 5, , 6]);
                return [4 /*yield*/, (0, Validations_1.OrderValidator)(req.body)];
            case 1:
                validate = _a.sent();
...
var deleteOrder = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, order.delete(parseInt(req.params.id))];
            case 1:
                results = _a.sent();
                res.send(results);
                return [3 /*break*/, 3];
