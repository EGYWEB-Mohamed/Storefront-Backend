...
var loginUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, user.login(parseInt(req.params.id))];
            case 1:
                results = _a.sent();
                res.send(results);
                return [2 /*return*/];
...
var user_routes = function (app) {
    app.get('/users', jwt_1.default, indexUser);
    app.get('/users/:id', jwt_1.default, showUser);
    app.post('/users', createUser);
    app.put('/users/:id', jwt_1.default, updateUser);
